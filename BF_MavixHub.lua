...
local Window = Fluent:CreateWindow({
    Title = "BloxFruit ( Beta )" .. Fluent.Version,
...
local Tabs = {
     Home = Window:AddTab({ Title = "บ้าน", Icon = "rbxassetid://15712703260" }),
    Main = Window:AddTab({ Title = "หลัก", Icon = "rbxassetid://105030991743587" }),
}
